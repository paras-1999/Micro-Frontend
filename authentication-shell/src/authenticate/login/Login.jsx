...
export default function Login() {
  ...
  <Form.Group className="mb-3" controlId="formBasicEmail">
    ...
    <Form.Control type="email" className='inputfields' value={username}
            onChange={(evt) => setUsername(evt.target.value)} required />
  </Form.Group>
  <Form.Group className="mb-3" controlId="formBasicPassword">
    <Form.Label>Password</Form.Label>
    <Form.Control type="password" className='inputfields' value={password}
  ...
  <p className='text-center mt-2 '><button type='button' className="forgetPassword">Forget Password</button><button className="forgetPassword" type='button' onClick={()=>{navigate("/signup")}}>SignUp</button></p>
</Form>
    </div>
  )
}